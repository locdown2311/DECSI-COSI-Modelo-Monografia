...
\begin{itemize}
	...
	\item \textbf{Redimensionamento Local}: Instalar APs adicionais em setores de sombra identificados como críticos (como o AP \texttt{RK-ceb0} e \texttt{unifi-ap-4-d}, que registraram as piores potências médias).
