...
Os coeficientes de Pearson medem a força de uma relação linear, enquanto os de Spearman medem a relação monotônica (útil para distribuições não-normais e não-lineares). Ambos variam de -1 a +1. Os símbolos `\textit{` representam significância estatística de }p\textit{ < 0.05 e `}\textit{` representam }p* < 0.01.
...
\IBGEtab{%
  ...
  \resizebox{\textwidth}{!}{%
    \begin{tabular}{lcccccc}
      ...
      \midrule
      \textbf{RSSI x Throughput Total} & -0.0086\textit{} & 0.0363\textit{} & 107726 & 0.2305\textit{} & 0.4512\textit{} & 11641 \\
      \textbf{RSSI x Retransmissoes} & 0.0215\textit{} & 0.1642\textit{} & 107726 & -0.3437\textit{} & -0.3660\textit{} & 11641 \\
      \textbf{Retransmissoes x Throughput Total} & -0.1009\textit{} & -0.0768\textit{} & 120510 & -0.0989\textit{} & -0.1321\textit{} & 11641 \\
      \textbf{Qtd Clientes x Throughput Agregado AP} & 0.6953\textit{} & 0.7962\textit{} & 16708 & 0.3310\textit{} & 0.5253\textit{} & 5506 \\
      \textbf{Qtd Clientes x Retransmissoes Medias AP} & -0.0590\textit{} & 0.3572\textit{} & 16708 & 0.1081\textit{} & 0.2302\textit{} & 5506 \\
      \textbf{Noise x Retransmissoes} & -0.3952\textit{} & -0.6323\textit{} & 107726 & 0.0447\textit{} & -0.0043 & 11641 \\
      \textbf{Noise x RSSI} & -0.3933\textit{} & -0.3762\textit{} & 107726 & 0.1053\textit{} & 0.0083 & 11641 \\
      \textbf{Link Speed TX x Throughput TX} & 0.1086\textit{} & 0.5475\textit{} & 112719 & 0.0536\textit{} & 0.2877\textit{} & 11641 \\
      \textbf{Volume Total x Tempo de Sessao} & 0.3417\textit{} & 0.6861\textit{} & 120510 & 0.0980\textit{} & 0.3121\textit{} & 11641 \\
      \bottomrule
    \end{tabular}%
  }%
}{%
