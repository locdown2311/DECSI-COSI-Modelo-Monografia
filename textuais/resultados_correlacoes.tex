...
\begin{itemize}
  \item \textbf{Arquivo}: \texttt{01\_rssi\_throughput.png}
...
\begin{itemize}
  \item \textbf{Arquivo}: \texttt{02\_rssi\_retransmissoes.png}
  \item \textbf{Visualização}:
\end{itemize}
\begin{figure}[H]
  \centering
...
\begin{itemize}
  \item \textbf{Arquivo}: \texttt{03\_retransmissoes\_throughput.png}
  \item \textbf{Visualização}:
\end{itemize}
\begin{figure}[H]
  \centering
...
\begin{itemize}
  \item \textbf{Arquivo}: \texttt{04\_clientes\_throughput\_ap.png}
  \item \textbf{Visualização}:
\end{itemize}
\begin{figure}[H]
  \centering
...
\begin{itemize}
  \item \textbf{Arquivo}: \texttt{05\_clientes\_retransmissoes\_ap.png}
  \item \textbf{Visualização}:
\end{itemize}
\begin{figure}[H]
  \centering
...
\begin{itemize}
  \item \textbf{Arquivo}: \texttt{06\_noise\_retransmissoes.png}
  \item \textbf{Visualização}:
\end{itemize}
\begin{figure}[H]
  \centering
...
\begin{itemize}
  \item \textbf{Arquivo}: \texttt{07\_noise\_rssi.png}
  \item \textbf{Visualização}:
\end{itemize}
\begin{figure}[H]
  \centering
...
\begin{itemize}
  \item \textbf{Arquivo}: \texttt{08\_link\_speed\_throughput.png}
  \item \textbf{Visualização}:
\end{itemize}
\begin{figure}[H]
  \centering
...
\begin{itemize}
  \item \textbf{Arquivo}: \texttt{09\_ruckus\_uptime\_volume.png}
  \item \textbf{Visualização}:
\end{itemize}
\begin{figure}[H]
  \centering
