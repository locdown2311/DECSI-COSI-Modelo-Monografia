...
\IBGEtab{%
  ...
  \resizebox{0.92\textwidth}{!}{%
    \begin{tabular}{lcccc}
      ...
      \midrule
      \textbf{Ruckus} & 446.060 & 0 & 446.060 & 0,00\% \\
      \textbf{UniFi} & 51.974 & 0 & 51.974 & 0,00\% \\
      \bottomrule
    \end{tabular}%
  }%
}{%
...
\IBGEtab{%
  ...
  \resizebox{0.78\textwidth}{!}{%
    \begin{tabular}{lccc}
      ...
      \midrule
      \textbf{Ruckus} & 23/06/2026 00:00 & 04/09/2026 23:55 & 20 dias com logs \\
      \textbf{UniFi} & 23/06/2026 00:02 & 04/09/2026 23:54 & 20 dias com logs \\
      \bottomrule
    \end{tabular}%
  }%
}{%
...
\textit{Nota: Ambos os datasets cobrem o mesmo período temporal (de 23/06/2026 00:00 a 04/09/2026 23:55, totalizando 20 dias com registros de log efetivamente monitorados), garantindo sobreposição temporal das amostras.}
...
\IBGEtab{%
  ...
  \resizebox{\textwidth}{!}{%
    \begin{tabular}{lccc}
      ...
      \texttt{RSSI} & 10,11\% & 0,00\% & Numérico \\
      \texttt{signal} & 10,11\% & 0,00\% & Numérico \\
      \texttt{noise} & 10,11\% & 0,00\% & Numérico \\
      ...
      \texttt{link\_speed\_tx\_mbps} & 8,02\% & 0,00\% & Numérico \\
